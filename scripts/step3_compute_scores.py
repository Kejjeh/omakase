...
def main():
    ...
    for r in restaurants:
        ...
        rows.append({
            ...
            # cuisine-extra fields (Italian and beyond)
            "subtype": r.get("subtype"),
            "famous_for": r.get("famous_for"),
            "tasting_format": r.get("tasting_format"),
            "price_level": r.get("price_level"),
            "typical_dinner_pp": r.get("typical_dinner_pp"),
            "pasta_program": r.get("pasta_program"),
            "pizza_program": r.get("pizza_program"),
